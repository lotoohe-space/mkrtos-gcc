...
fn_ptr sys_call_table[] = {sys_setup, sys_exit, sys_fork, sys_read,
                           ...
                           NULL,//sys_umount,
                           sys_setuid, sys_getuid, sys_stime, sys_ptrace, sys_alarm,
                           NULL,//sys_fstat,
                           NULL,//sys_pause,
                           sys_utime, sys_stty, sys_gtty, sys_access,
                           sys_nice, sys_ftime, //sys_sync,
                           NULL, //sys_kill,
                           sys_rename, sys_mkdir,
                           sys_rmdir, sys_dup, //sys_pipe,
                           sys_times, sys_prof, sys_brk, sys_setgid,
